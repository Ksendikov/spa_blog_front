<template>
  <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
    <nuxt-link class="navbar-brand" to="/">
      <img src="https://upload.wikimedia.org/wikipedia/commons/9/9f/The_International_Forensic_Medicine_Association_Logo.png" width="30" height="30" alt="logo">
    </nuxt-link>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <nuxt-link class="btn btn-outline-dark" to="/signout">Выход</nuxt-link>
      <nuxt-link class="btn btn-outline-dark mr-2" to="/signin">Вход</nuxt-link>
      <nuxt-link class="btn btn-outline-dark mr-2" to="/signup">Регистрация</nuxt-link>
    </div>
  </nav>
</template>
